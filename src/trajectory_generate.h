...
vector<vector<double>> traj_gen(double &car_s, double &ref_vel, vector<double> &previous_path_x, vector<double> &previous_path_y, double &car_yaw, double &car_x, double &car_y, int &lane, vector<double> &map_waypoints_s, vector<double> &map_waypoints_x, vector<double> &map_waypoints_y)
{
  vector<double> ptsx;
  vector<double> ptsy;
